 ...
 * OpenAI-Java
 *
 * Java libraries for using OpenAI's GPT apis. Supports GPT-3, ChatGPT, and
 * GPT-4.
 *
 * Includes the following artifacts:
 *
 * api : request/response POJOs for the GPT APIs. client : a basic retrofit
 * client for the GPT endpoints, includes the api module service : A basic
 * service class that creates and calls the client. This is the easiest way to
 * get started.
 *
 */
